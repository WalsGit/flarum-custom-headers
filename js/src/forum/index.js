...
app.initializers.add('walsgit/custom-headers', () => {
    extend(IndexPage.prototype, 'oncreate', function (){
        ...
        const bgImageUrl = app.forum.attribute('walsgit-custom-headers.headerBackgroundImage') || app.forum.attribute('baseUrl') + '/assets/extensions/walsgit-custom-headers/bg.jpg';
    ...
    extend(IndexPage.prototype, 'view', function (vdom) {
        if (vdom.children && vdom.children.splice) {
            ...
            const bg = app.forum.attribute('baseUrl') + '/assets/extensions/walsgit-custom-headers/bg.jpg';
                ...
                view: function (vnode) {
                    if (!user)
                        return m(
                            ...
                            app.translator.trans('custom-headers.forum.signup')
                        );
                },
            };
                ...
                view: function (vnode) {
                    if (!user)
                        return m(
                            ...
                            app.translator.trans('custom-headers.forum.login')
                        );
                },
            };
            // inizio icone social
                        ...
                        m('a', { className: 'js-nav', 'data-element': 'logo', target: '_blank' }, [
                            m('a',
                                { href: app.forum.attribute('twitterIcon'),
                                  title: app.translator.trans('custom-headers.forum.twitter') },
                                m(twitterIcon)
                            ),
                            m('a',
                                {
                                    href: app.forum.attribute('facebookIcon'),
                                    title: app.translator.trans('custom-headers.forum.facebook'),
                                },
                                m(facebookIcon)
                            ),
                            m('a',
                                {
                                    ...
                                    title: app.translator.trans('custom-headers.forum.youtube'),
                                },
                                m(youtubeIcon)
                            ),
                            m('a',
                                {
                                    ...
                                    title: app.translator.trans('custom-headers.forum.github'),
                                },
                                m(gitHubIcon)
                            ),
                        ]),
